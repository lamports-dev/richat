...
Then create a config with your details following the example [config.yml](https://raw.githubusercontent.com/lamports-dev/richat/master/richat/config.yml) and run Richat with:
